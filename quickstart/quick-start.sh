...
RUNTRUE_AUTOSCALER_IMAGE=${RUNTRUE_AUTOSCALER_IMAGE:-ghcr.io/runtrue/github-actions-server:quickstart-autoscaler-latest}
...
readonly RUNTRUE_REPOSITORY_ACTION_IMAGE_REPOSITORY RUNTRUE_REPOSITORY_ACTION_ALLOWED_BASE_IMAGES
...
import json, sys
template, minimum, minimum_idle, maximum, idle = sys.argv[1:]
minimum = int(minimum)
